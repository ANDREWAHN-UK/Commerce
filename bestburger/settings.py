"""
Django settings for bestburger project.
...
SECRET_KEY = 'django-insecure-%@wyjynzy4!rw2v=2r!4s8c8y(u(mg43$urvffz(2pf+-hq4!^'
...
# the below makes it so the url picks up on the images
MEDIA_URL = '/media/'
