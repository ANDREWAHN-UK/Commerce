...
def updateItem(request):
	...
	# get or create here to allow the editing of a cart item without having to reload the page. 
	...
	#  this just tells the cart that if an item is at 0, to delete that item entirely
